...
const formatApiUrl = (market, date) => {
	const apiUrl = `${baseApiUrl}m=${market}&SubmitButton=Draw&r=60&i=1-day&c=1&s=${date}&e=${date}&Prev=&Next=&t=S&b=&a1=&m1=10&a2=&m2=25&x=0&i1=&i2=&i3=&i4=&v=1&cv=0&ps=0&l=0&p=0&`
	return apiUrl
}
